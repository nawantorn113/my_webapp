...
>**❗️ folder สำหรับการกำหนดลักษณะของแต่ละ pages โดยจะมีการเรียกใช้จาก [views.py]

>**🔻 ดังตัวอย่างของไฟล์ [index.html]
...
{% endblock Content %}
```
>**🔺 จุดสังเกตที่เห็นได้ชัดคือมีการใช้ for loop ในการวนซ้ำเพื่อเรียกค่าของนักศึกษาทุกคนมาแสดง และมีการเชื่อม url และส่งค่า ID ไปยัง [details.html]เพื่อแสดงข้อมูลแบบเฉพาะเจาะจง**

## 📕6. [views.py]

>**❗️ พื้นที่สำหรับการ functions ต่างๆไปยัง ทั้งในส่วนของการเรียกใช้ [template] และการสร้าง functions ต่างๆ เพื่อใช้ในการเรียกใช้งาน โดยจะมีการเรียกใช้จาก [urls.py]
```py
...
>**🔺 functions ที่มีการเรียกใช้ style จาก [template] แล้วจะมีใช้ return เพื่อส่งออกค่า ซึ่งในส่วนนี้จะมีการเรียกใช้งานจาก [urls.py]


>**🔻 StudentDetails เป็น function ที่จะถูกเรียกใช้จาก [urls.py] ในส่วนแรก และมีการส่งค่าไปยัง [details.html]เป็นส่วนต่อไป**
...
>**🔻 getModelChoice เป็น function เพื่อใช้ในการเปลี่ยนค่า prefix จากตัวเลข เป็นตัวอักษร ซึ่งค่าของ prefix นั้นจะถูกดึงข้อมูลมาจาก [model.py]
